...
data_path = 'error_data.csv'  # Update with your file path
...
data.to_csv('slam_clustered_data.csv', index=False)

print("Clustered data saved to 'slam_clustered_data.csv'.")
